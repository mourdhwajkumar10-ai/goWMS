...
var Catalog = []Permission{
	...
	{Code: "picking.override", Module: "picking", Name: "Override pick scan", Description: "Supervisor override for wrong location/item during pick"},
	{Code: "packing.access", Module: "packing", Name: "Packing", Description: "Pack sessions"},
	{Code: "counter_sale.access", Module: "counter_sale", Name: "Counter sale", Description: "Quick counter-sale fulfillment"},
